...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/clustering_data.o \
	${OBJECTDIR}/forecast.o \
	${OBJECTDIR}/main.o
...
LDLIBSOPTIONS=-L/usr/include -lboost_system -lboost_filesystem -L/usr/X11R6/lib -lm -lpthread -lX11

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ocr

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ocr: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ocr ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/clustering_data_nomain.o: ${OBJECTDIR}/clustering_data.o clustering_data.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/clustering_data.o`; \
...
${OBJECTDIR}/forecast_nomain.o: ${OBJECTDIR}/forecast.o forecast.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/forecast.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ocr
